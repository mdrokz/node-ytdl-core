const PassThrough = typeof process !== 'undefined' ? require('stream').PassThrough : require('react-native-streams').PassThrough;
const getInfo = require('./info');
const utils = require('./utils');
const formatUtils = require('./format-utils');
const urlUtils = require('./url-utils');
const sig = require('./sig');
const dispatchXHR = require('./xhr');
const miniget = typeof process !== 'undefined' ? require('miniget') : require('./xhr');
  ...
  if (format.isHLS || format.isDashMPD) {
    ...
    if (shouldBeChunked) {
      ...
      const getNextChunk = () => {
        ...
        req = dispatchXHR(format.url, requestOptions);
        req.on('data', ondata);
        req.on('end', () => {
          if (stream.destroyed) {
            return;
