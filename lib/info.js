...
const miniget = typeof process.version !== 'undefined' ? require('miniget') : require('./xhr');
const utils = require('./utils');
// Forces Node JS version of setTimeout for Electron based applications
const setTimeout = typeof process.version !== 'undefined' ? require('timers').setTimeout : window.setTimeout;
